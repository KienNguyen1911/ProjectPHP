                    ...
                    <div class="row gutter-v2 gallery">
                        <?php foreach ($images as $image): ?>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <a href="<?php echo $image['image_name'] ?>" class="gal-item" data-fancybox="gal"
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <form class="contact-form" action="index.php?controller=VNPay&action=getVnpay&id=<?php echo $_GET['id'] ?>" data-aos="fade-up" data-aos-delay="200" method="post">

                        <div class="form-group">
                            <label class="text-black" for="email">Name Home</label>
                            <input type="text" class="form-control" id="email" value="<?php echo $booking[0]['name'] ?>"
                                readonly>
                        </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="fname"
                                        value="<?php echo $booking[0]['start'] ?>" readonly>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="lname"
                                        value="<?php echo $booking[0]['end'] ?>" readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input name="" class="form-control" id="message" cols="30" rows="5"
                                        value="<?php echo "$" . $booking[0]['price'] ?>" readonly>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input name="" class="form-control" id="message" cols="30" rows="5"
                                        value="<?php echo $days = round(abs(strtotime($booking[0]['end']) - strtotime($booking[0]['start'])) / 86400) ?>"
                                        readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="total" class="form-control" id="message" cols="30" rows="5"
                                value="<?php echo $booking[0]['price'] * $days ?>" readonly>
                        </div>
