...
<body class="g-sidenav-show  bg-gray-100">
  <section class="min-vh-100 mb-8">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('Views/assets/img/curved-images/curved14.jpg');">
      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="post" action="index.php?controller=login&action=postSignup">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Phonenumber" aria-label="Password" aria-describedby="password-addon" name="phonenumber">
                </div>
                <div class="mb-3">
                  <select class="form-control" name="role" id="choices-button" placeholder="Role">
                ...
                <p class="text-sm mt-3 mb-0">Already have an account? <a href="index.php?controller=admin&action=signin" class="text-dark font-weight-bolder">Sign in</a></p>
              </form>
            </div>
