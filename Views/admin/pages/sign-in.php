  ...
  <main class="main-content  mt-0">
    ...
    <?php if (isset($_SESSION['message'])) { ?>
      <div class="alert alert-primary alert-dismissible fade show" role="alert">
        ...
        <span class="alert-text text-white"><strong>Wrong!!!</strong> Username or Password is incorrect!!!</span>
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  ...
                  <form role="form" method="post" action="index.php?controller=login&action=postLogin">
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('Views/assets/img/curved-images/curved6.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
